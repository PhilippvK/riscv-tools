...
then
  ...
  then
    ...
    # git config --global --add url."https://github.com/RTEMS/sourceware-mirror-binutils-gdb.git".insteadOf "https://sourceware.org/git/binutils-gdb.git"
    ...
    git config --global --add url."https://github.com/gnutools/binutils-gdb".insteadOf "https://sourceware.org/git/binutils-gdb"
    ...
    # git config --global --add url."https://github.com/gnutools/newlib-cygwin".insteadOf "https://sourceware.org/git/newlib-cygwin"
    ...
    git config --global --add url."https://github.com/gnutools/glibc".insteadOf "https://sourceware.org/git/glibc"
  ...
  then
    ...
    if [[ "$LLVM_STRIP" == true ]]
    then
        cmake --build "$WORKDIR/llvm/build" -t install/strip 2>&1 | tee -a $LOGDIR/llvm.log
    else
